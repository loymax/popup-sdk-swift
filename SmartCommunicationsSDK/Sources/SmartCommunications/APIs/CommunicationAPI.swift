...
open class CommunicationAPI {
     ...
     */
    @discardableResult
    open class func logPushEvent(type: String, logPushEventRequest: LogPushEventRequest? = nil, apiResponseQueue: DispatchQueue = SmartCommunicationsAPI.apiResponseQueue, completion: @escaping ((_ data: LogPushEvent200Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    open class func logPushEventWithRequestBuilder(type: String, logPushEventRequest: LogPushEventRequest? = nil) -> RequestBuilder<LogPushEvent200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<LogPushEvent200Response>.Type = SmartCommunicationsAPI.requestBuilderFactory.getBuilder()
